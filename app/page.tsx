        ...
        <div className='max-w-[1000px] w-full flex flex-col justify-start  gap-y-20 '>
          ...
          <div className='flex flex-col gap-y-10'>
            <div>
              ...
              <p className='max-w-[600px] opacity-75 text-xl ml-5'>
            ...
            <div>
              ...
              <span className='opacity-75 text-xl ml-5'>Photos from my recent travels. </span>
              <Gallery />
            </div>
            <div>
              <span className='opacity-75 text-xl ml-5'>Here is how much I have cycled in the past year.</span>
              <ActivityStats />
            </div>
          
          </div>
          <div className='flex flex-col place-items-start gap-y-5'>
